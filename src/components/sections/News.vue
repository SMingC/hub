...
<script>
import NewsInformation from "@/components/cards/NewsInformation.vue";
import FarmCard from "@/components/cards/FarmCard.vue";
import TeamCard from "@/components/cards/TeamCard.vue";
import Cook from "@/components/illustrations/Cook.vue";
import Hand from "@/components/button/Hand.vue";
import Pick from "@/components/cards/Pick.vue";
export default {
  data() {
    return {
      currentScroll: 0,
